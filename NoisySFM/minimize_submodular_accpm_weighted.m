function [primal_variable,dual_variable, dual_values, primal_values, gaps,added1,added2,added3] = minimize_submodular_accpm_weighted(F,F_true,param_F,maxiter,gap,optimal_primal)
% minimize submodular function by ACCPM with a high weight on one of the
% constraint: emulates Kelley;s method.
