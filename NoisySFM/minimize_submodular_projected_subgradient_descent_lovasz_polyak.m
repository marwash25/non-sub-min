function [x_primal,x_dual,dual_values,primal_values,gaps,added1,added2,added3]  = minimize_submodular_projected_subgradient_descent_lovasz_polyak(F,F_true,param_F,maxiter,optimal_primal)
